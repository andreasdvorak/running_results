...
from .views import (
    ...
    annual_results_m_view,
    annual_results_w_view,
    club_view,
    ...
    years_with_annual_results_m_view,
    years_with_annual_results_w_view,
...
urlpatterns = [
    ...
    path('annualrecordlistw/year:<int:year>/',
        ...
        path('annualresultlistm', years_with_annual_results_m_view,
            name='annual-result-list-m'),
        path('annualresultlistm/year:<int:year>/', annual_results_m_view,
            name='annual-results-m-for-year-list'),
        path('annualresultlistw', years_with_annual_results_w_view,
            name='annual-result-list-w'),
        path('annualresultlistw/year:<int:year>/', annual_results_w_view,
            name='annual-results-w-for-year-list'),
    path('club_details', club_view, name='club_view'),
    path('disciplines', discipline_list_view, name='discipline-list'),
        path('disciplines/<int:discipline_id>/',
            discipline_detail_view, name='discipline_distance_details'),
    ...
    path('event/<int:event_id>/', event_detail_view, name='events-detail'),
